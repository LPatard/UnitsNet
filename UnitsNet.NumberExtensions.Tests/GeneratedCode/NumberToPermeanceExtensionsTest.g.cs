...
using UnitsNet.NumberExtensions.NumberToPermeance;
using Xunit;

namespace UnitsNet.Tests
{    
    public class NumberToPermeanceExtensionsTests
    {
        [Fact]
        ...
        [Fact]
        public void NumberToPermsTest() =>
            Assert.Equal(Permeance.FromPerms(2), 2.Perms());
