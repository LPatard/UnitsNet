...
namespace UnitsNet
{
    ...
    public sealed partial class EnergyDensity : IQuantity
    {
        ...
        public static EnergyDensity FromJoulePerCubicMeters(double joulepercubicmeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static EnergyDensity FromWattSecondCubicMeters(double wattsecondcubicmeters)
        {
