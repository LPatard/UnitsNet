...
namespace UnitsNet
{
    ...
    public sealed partial class DoseRate : IQuantity
    {
        /// <summary>
        ...
        static DoseRate()
        {
            ...
            Info = new QuantityInfo(QuantityType.DoseRate, Units.Cast<Enum>().ToArray(), BaseUnit, Zero, BaseDimensions);
        }

        /// <summary>
        ///     Creates the quantity with a value of 0 in the base unit GrayPerSecond.
        /// </summary>
        /// <remarks>
        ...
        private DoseRate(double value, DoseRateUnit unit)
        {
        ...
        public static string GetAbbreviation(DoseRateUnit unit, [CanBeNull] string cultureName)
        {
        ...
        public static DoseRate FromGrayPerSeconds(double grayperseconds)
        {
        ...
        public static DoseRate From(double value, DoseRateUnit fromUnit)
        {
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static DoseRate Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out DoseRate result)
        {
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out DoseRate result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static DoseRateUnit ParseUnit(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParseUnit(string str, [CanBeNull] string cultureName, out DoseRateUnit unit)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(DoseRate other)
        {
        ...
        double IQuantity.As(object unit) => As((DoseRateUnit)unit);
        ...
        private double AsBaseNumericType(DoseRateUnit unit)
        {
            if(Unit == unit)
                return _value;
