...
namespace UnitsNet.Tests
{
    public partial class IQuantityTests
    {
        ...
        public void From_ValueAndUnit_ReturnsQuantityWithSameValueAndUnit()
        {
            ...
            Assertion(3, AbsorbedDoseUnit.Sievert, Quantity.From(3, AbsorbedDoseUnit.Sievert));
            Assertion(3, AccelerationUnit.StandardGravity, Quantity.From(3, AccelerationUnit.StandardGravity));
            Assertion(3, ActivityUnit.Becquerel, Quantity.From(3, ActivityUnit.Becquerel));
            ...
            Assertion(3, AreaDensityUnit.KipsPerSquareInch, Quantity.From(3, AreaDensityUnit.KipsPerSquareInch));
            Assertion(3, AreaMomentOfInertiaUnit.MillimeterToTheFourth, Quantity.From(3, AreaMomentOfInertiaUnit.MillimeterToTheFourth));
            Assertion(3, AreaVolumeRationUnit.SquareMeterPerLiter, Quantity.From(3, AreaVolumeRationUnit.SquareMeterPerLiter));
            Assertion(3, BaudRateUnit.Baud, Quantity.From(3, BaudRateUnit.Baud));
            ...
            Assertion(3, CatalyticActivityUnit.Katal, Quantity.From(3, CatalyticActivityUnit.Katal));
            Assertion(3, CatalyticVolumeActivityUnit.KatalPerCubicMeter, Quantity.From(3, CatalyticVolumeActivityUnit.KatalPerCubicMeter));
            ...
            Assertion(3, DiffusivityUnit.SquareMeterPerHour, Quantity.From(3, DiffusivityUnit.SquareMeterPerHour));
            Assertion(3, DoseRateUnit.GrayPerSecond, Quantity.From(3, DoseRateUnit.GrayPerSecond));
            ...
            Assertion(3, EnergyDensityUnit.WattSecondCubicMeter, Quantity.From(3, EnergyDensityUnit.WattSecondCubicMeter));
            ...
            Assertion(3, HeatCapacityUnit.BTUPerFahrenheitDegree, Quantity.From(3, HeatCapacityUnit.BTUPerFahrenheitDegree));
            Assertion(3, HeatFluxUnit.WattPerSquareMeter, Quantity.From(3, HeatFluxUnit.WattPerSquareMeter));
            Assertion(3, HeatTransferCoefficientUnit.WattPerSquareMetterPerKelvin, Quantity.From(3, HeatTransferCoefficientUnit.WattPerSquareMetterPerKelvin));
            ...
            Assertion(3, IonDoseUnit.CoulombPerKilogramm, Quantity.From(3, IonDoseUnit.CoulombPerKilogramm));
            ...
            Assertion(3, LuminanceUnit.FootLambert, Quantity.From(3, LuminanceUnit.FootLambert));
            Assertion(3, LuminosityUnit.Watt, Quantity.From(3, LuminosityUnit.Watt));
            Assertion(3, LuminousEfficacyUnit.LumenPerWatt, Quantity.From(3, LuminousEfficacyUnit.LumenPerWatt));
            ...
            Assertion(3, PermeanceUnit.Perm, Quantity.From(3, PermeanceUnit.Perm));
            Assertion(3, PermittivityUnit.MicroFaradPerKilometer, Quantity.From(3, PermittivityUnit.MicroFaradPerKilometer));
            ...
            Assertion(3, PressureUnit.WaterMillimeter, Quantity.From(3, PressureUnit.WaterMillimeter));
            Assertion(3, PressureChangeRateUnit.PascalPerSecond, Quantity.From(3, PressureChangeRateUnit.PascalPerSecond));
            Assertion(3, PressureGradientUnit.PascalPerMeter, Quantity.From(3, PressureGradientUnit.PascalPerMeter));
            Assertion(3, RadianceUnit.WattPerSquareMeterSteradian, Quantity.From(3, RadianceUnit.WattPerSquareMeterSteradian));
            Assertion(3, RadiantIntensityUnit.WattPerSteradian, Quantity.From(3, RadiantIntensityUnit.WattPerSteradian));
            ...
            Assertion(3, SpaceVelocityUnit.LiterPerSecondCubicMeter, Quantity.From(3, SpaceVelocityUnit.LiterPerSecondCubicMeter));
            Assertion(3, SpecificAreaUnit.SquareFootPerTon, Quantity.From(3, SpecificAreaUnit.SquareFootPerTon));
            Assertion(3, SpecificDischargeUnit.LiterSecondPerSquareMeter, Quantity.From(3, SpecificDischargeUnit.LiterSecondPerSquareMeter));
            ...
            Assertion(3, SpecificHeatEnergyUnit.JoulePerGramCelciusDegree, Quantity.From(3, SpecificHeatEnergyUnit.JoulePerGramCelciusDegree));
            Assertion(3, SpecificLengthUnit.MeterPerGram, Quantity.From(3, SpecificLengthUnit.MeterPerGram));
            ...
            Assertion(3, TemperatureCoefficientUnit.PercentageByKelvin, Quantity.From(3, TemperatureCoefficientUnit.PercentageByKelvin));
            Assertion(3, TemperatureDeltaUnit.MillidegreeCelsius, Quantity.From(3, TemperatureDeltaUnit.MillidegreeCelsius));
            Assertion(3, ThermalLengthExpansionUnit.MillimeterPerMeterKelvinDegree, Quantity.From(3, ThermalLengthExpansionUnit.MillimeterPerMeterKelvinDegree));
            ...
            Assertion(3, ThermalInsulanceUnit.SquareMeterCelciusDegreePerKilowatt, Quantity.From(3, ThermalInsulanceUnit.SquareMeterCelciusDegreePerKilowatt));
        ...
        public void QuantityInfo_IsSameAsStaticInfoProperty()
        {
            ...
            Assertion(AbsorbedDose.Info, AbsorbedDose.Zero);
            Assertion(Acceleration.Info, Acceleration.Zero);
            Assertion(Activity.Info, Activity.Zero);
            ...
            Assertion(AreaVolumeRation.Info, AreaVolumeRation.Zero);
            Assertion(BaudRate.Info, BaudRate.Zero);
            ...
            Assertion(CatalyticActivity.Info, CatalyticActivity.Zero);
            Assertion(CatalyticVolumeActivity.Info, CatalyticVolumeActivity.Zero);
            Assertion(CoefficientOfThermalExpansion.Info, CoefficientOfThermalExpansion.Zero);
            Assertion(Density.Info, Density.Zero);
            Assertion(Diffusivity.Info, Diffusivity.Zero);
            Assertion(DoseRate.Info, DoseRate.Zero);
            ...
            Assertion(HeatCapacity.Info, HeatCapacity.Zero);
            ...
            Assertion(IonDose.Info, IonDose.Zero);
            ...
            Assertion(LuminousEfficacy.Info, LuminousEfficacy.Zero);
            ...
            Assertion(Permeance.Info, Permeance.Zero);
            ...
            Assertion(PressureGradient.Info, PressureGradient.Zero);
            Assertion(Radiance.Info, Radiance.Zero);
            Assertion(RadiantIntensity.Info, RadiantIntensity.Zero);
            ...
            Assertion(SpaceVelocity.Info, SpaceVelocity.Zero);
            Assertion(SpecificArea.Info, SpecificArea.Zero);
            Assertion(SpecificDischarge.Info, SpecificDischarge.Zero);
            Assertion(SpecificEnergy.Info, SpecificEnergy.Zero);
            Assertion(SpecificEntropy.Info, SpecificEntropy.Zero);
            Assertion(SpecificHeatEnergy.Info, SpecificHeatEnergy.Zero);
            Assertion(SpecificLength.Info, SpecificLength.Zero);
            ...
            Assertion(TemperatureCoefficient.Info, TemperatureCoefficient.Zero);
            Assertion(TemperatureDelta.Info, TemperatureDelta.Zero);
            Assertion(ThermalLengthExpansion.Info, ThermalLengthExpansion.Zero);
        ...
        public void Type_EqualsStaticQuantityTypeProperty()
        {
            ...
            Assertion(AbsorbedDose.QuantityType, AbsorbedDose.Zero);
            Assertion(Acceleration.QuantityType, Acceleration.Zero);
            Assertion(Activity.QuantityType, Activity.Zero);
            ...
            Assertion(AreaVolumeRation.QuantityType, AreaVolumeRation.Zero);
            Assertion(BaudRate.QuantityType, BaudRate.Zero);
            ...
            Assertion(CatalyticActivity.QuantityType, CatalyticActivity.Zero);
            Assertion(CatalyticVolumeActivity.QuantityType, CatalyticVolumeActivity.Zero);
            ...
            Assertion(Diffusivity.QuantityType, Diffusivity.Zero);
            Assertion(DoseRate.QuantityType, DoseRate.Zero);
            ...
            Assertion(HeatCapacity.QuantityType, HeatCapacity.Zero);
            ...
            Assertion(IonDose.QuantityType, IonDose.Zero);
            ...
            Assertion(LuminousEfficacy.QuantityType, LuminousEfficacy.Zero);
            ...
            Assertion(Permeance.QuantityType, Permeance.Zero);
            ...
            Assertion(PressureGradient.QuantityType, PressureGradient.Zero);
            Assertion(Radiance.QuantityType, Radiance.Zero);
            Assertion(RadiantIntensity.QuantityType, RadiantIntensity.Zero);
            ...
            Assertion(SpaceVelocity.QuantityType, SpaceVelocity.Zero);
            Assertion(SpecificArea.QuantityType, SpecificArea.Zero);
            Assertion(SpecificDischarge.QuantityType, SpecificDischarge.Zero);
            Assertion(SpecificEnergy.QuantityType, SpecificEnergy.Zero);
            Assertion(SpecificEntropy.QuantityType, SpecificEntropy.Zero);
            Assertion(SpecificHeatEnergy.QuantityType, SpecificHeatEnergy.Zero);
            Assertion(SpecificLength.QuantityType, SpecificLength.Zero);
            ...
            Assertion(TemperatureCoefficient.QuantityType, TemperatureCoefficient.Zero);
            Assertion(TemperatureDelta.QuantityType, TemperatureDelta.Zero);
            Assertion(ThermalLengthExpansion.QuantityType, ThermalLengthExpansion.Zero);
            Assertion(ThermalConductance.QuantityType, ThermalConductance.Zero);
            Assertion(ThermalConductivity.QuantityType, ThermalConductivity.Zero);
            Assertion(ThermalInsulance.QuantityType, ThermalInsulance.Zero);
        ...
        public void Dimensions_IsSameAsStaticBaseDimensions()
        {
            ...
            Assertion(AbsorbedDose.BaseDimensions, AbsorbedDose.Zero);
            Assertion(Acceleration.BaseDimensions, Acceleration.Zero);
            Assertion(Activity.BaseDimensions, Activity.Zero);
            ...
            Assertion(AreaVolumeRation.BaseDimensions, AreaVolumeRation.Zero);
            Assertion(BaudRate.BaseDimensions, BaudRate.Zero);
            ...
            Assertion(CatalyticActivity.BaseDimensions, CatalyticActivity.Zero);
            Assertion(CatalyticVolumeActivity.BaseDimensions, CatalyticVolumeActivity.Zero);
            ...
            Assertion(Diffusivity.BaseDimensions, Diffusivity.Zero);
            Assertion(DoseRate.BaseDimensions, DoseRate.Zero);
            ...
            Assertion(HeatCapacity.BaseDimensions, HeatCapacity.Zero);
            ...
            Assertion(IonDose.BaseDimensions, IonDose.Zero);
            ...
            Assertion(LuminousEfficacy.BaseDimensions, LuminousEfficacy.Zero);
            ...
            Assertion(Permeance.BaseDimensions, Permeance.Zero);
            ...
            Assertion(PressureGradient.BaseDimensions, PressureGradient.Zero);
            Assertion(Radiance.BaseDimensions, Radiance.Zero);
            Assertion(RadiantIntensity.BaseDimensions, RadiantIntensity.Zero);
            ...
            Assertion(SpaceVelocity.BaseDimensions, SpaceVelocity.Zero);
            Assertion(SpecificArea.BaseDimensions, SpecificArea.Zero);
            Assertion(SpecificDischarge.BaseDimensions, SpecificDischarge.Zero);
            Assertion(SpecificEnergy.BaseDimensions, SpecificEnergy.Zero);
            Assertion(SpecificEntropy.BaseDimensions, SpecificEntropy.Zero);
            Assertion(SpecificHeatEnergy.BaseDimensions, SpecificHeatEnergy.Zero);
            Assertion(SpecificLength.BaseDimensions, SpecificLength.Zero);
            ...
            Assertion(TemperatureCoefficient.BaseDimensions, TemperatureCoefficient.Zero);
            Assertion(TemperatureDelta.BaseDimensions, TemperatureDelta.Zero);
            Assertion(ThermalLengthExpansion.BaseDimensions, ThermalLengthExpansion.Zero);
            Assertion(ThermalConductance.BaseDimensions, ThermalConductance.Zero);
