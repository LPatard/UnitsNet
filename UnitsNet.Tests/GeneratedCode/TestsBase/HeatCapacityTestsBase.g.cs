...
{
    /// <summary>
    /// Test of HeatCapacity.
    /// </summary>
// ReSharper disable once PartialTypeWithSinglePart
    public abstract partial class HeatCapacityTestsBase
    {
        protected abstract double BTUPerFahrenheitDegreesInOneBTUPerFahrenheitDegree { get; }

// ReSharper disable VirtualMemberNeverOverriden.Global
        protected virtual double BTUPerFahrenheitDegreesTolerance { get { return 1e-5; } }
// ReSharper restore VirtualMemberNeverOverriden.Global

        [Fact]
        public void Ctor_WithUndefinedUnit_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => new HeatCapacity((double)0.0, HeatCapacityUnit.Undefined));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new HeatCapacity(double.PositiveInfinity, HeatCapacityUnit.BTUPerFahrenheitDegree));
            Assert.Throws<ArgumentException>(() => new HeatCapacity(double.NegativeInfinity, HeatCapacityUnit.BTUPerFahrenheitDegree));
        }

        [Fact]
        public void Ctor_WithNaNValue_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => new HeatCapacity(double.NaN, HeatCapacityUnit.BTUPerFahrenheitDegree));
        }

        [Fact]
        public void Ctor_NullAsUnitSystem_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new HeatCapacity(value: 1.0, unitSystem: null));
        }
...
#pragma warning restore 618
        ...
        [Fact]
        public void BTUPerFahrenheitDegreeToHeatCapacityUnits()
        {
            HeatCapacity btuperfahrenheitdegree = HeatCapacity.FromBTUPerFahrenheitDegrees(1);
            AssertEx.EqualTolerance(BTUPerFahrenheitDegreesInOneBTUPerFahrenheitDegree, btuperfahrenheitdegree.BTUPerFahrenheitDegrees, BTUPerFahrenheitDegreesTolerance);
        }
        ...
        [Fact]
        public void FromBTUPerFahrenheitDegrees_WithInfinityValue_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => HeatCapacity.FromBTUPerFahrenheitDegrees(double.PositiveInfinity));
            Assert.Throws<ArgumentException>(() => HeatCapacity.FromBTUPerFahrenheitDegrees(double.NegativeInfinity));
        }

        [Fact]
        public void FromBTUPerFahrenheitDegrees_WithNanValue_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => HeatCapacity.FromBTUPerFahrenheitDegrees(double.NaN));
        }
        ...
        public void As()
        {
            ...
            AssertEx.EqualTolerance(BTUPerFahrenheitDegreesInOneBTUPerFahrenheitDegree, btuperfahrenheitdegree.As(HeatCapacityUnit.BTUPerFahrenheitDegree), BTUPerFahrenheitDegreesTolerance);
        }
        ...
        {
            HeatCapacity btuperfahrenheitdegree = HeatCapacity.FromBTUPerFahrenheitDegrees(1);
            AssertEx.EqualTolerance(1, HeatCapacity.FromBTUPerFahrenheitDegrees(btuperfahrenheitdegree.BTUPerFahrenheitDegrees).BTUPerFahrenheitDegrees, BTUPerFahrenheitDegreesTolerance);
        }
        ...
        {
            HeatCapacity btuperfahrenheitdegree = HeatCapacity.FromBTUPerFahrenheitDegrees(1);
            Assert.Throws<ArgumentException>(() => btuperfahrenheitdegree.CompareTo(new object()));
        }
        ...
        {
            HeatCapacity btuperfahrenheitdegree = HeatCapacity.FromBTUPerFahrenheitDegrees(1);
            Assert.Throws<ArgumentNullException>(() => btuperfahrenheitdegree.CompareTo(null));
        }
...
// ReSharper restore EqualExpressionComparison
        ...
        {
            Assert.DoesNotContain(HeatCapacityUnit.Undefined, HeatCapacity.Units);
        }

        [Fact]
        public void HasAtLeastOneAbbreviationSpecified()
        {
            var units = Enum.GetValues(typeof(HeatCapacityUnit)).Cast<HeatCapacityUnit>();
        ...
        {
            Assert.False(HeatCapacity.BaseDimensions is null);
        }
        ...
        public void ToString_ReturnsValueAndUnitAbbreviationInCurrentCulture()
        {
            ...
            try {
                Assert.Equal("1 BTU/°F", new HeatCapacity(1, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString());
            }
            finally
            {
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 BTU/°F", new HeatCapacity(1, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString(swedishCulture));
        }
        ...
        public void ToString_SFormat_FormatsNumberWithGivenDigitsAfterRadixForCurrentCulture()
        {
            ...
            try
            {
                ...
                Assert.Equal("0.1 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s1"));
                Assert.Equal("0.12 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s2"));
                Assert.Equal("0.123 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s3"));
                Assert.Equal("0.1235 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s4"));
            }
            finally
            {
        ...
        public void ToString_SFormatAndCulture_FormatsNumberWithGivenDigitsAfterRadixForGivenCulture()
        {
            ...
            Assert.Equal("0.1 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s1", culture));
            Assert.Equal("0.12 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s2", culture));
            Assert.Equal("0.123 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s3", culture));
            Assert.Equal("0.1235 BTU/°F", new HeatCapacity(0.123456, HeatCapacityUnit.BTUPerFahrenheitDegree).ToString("s4", culture));
        }
