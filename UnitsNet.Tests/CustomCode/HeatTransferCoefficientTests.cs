...
namespace UnitsNet.Tests.CustomCode
{
    public class HeatTransferCoefficientTests : HeatTransferCoefficientTestsBase
    {
        ...
        protected override double BtuPerHourSquarefeetFahrenheitsInOneWattPerSquareMeterKelvin => throw new NotImplementedException();

        protected override double WattPerSquareMetterPerKelvinsInOneWattPerSquareMeterKelvin => throw new NotImplementedException();
    }
}
