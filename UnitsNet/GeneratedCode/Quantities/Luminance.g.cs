...
namespace UnitsNet
{
    ...
    public partial struct Luminance : IQuantity<LuminanceUnit>, IEquatable<Luminance>, IComparable, IComparable<Luminance>, IConvertible, IFormattable
    {
        ...
        static Luminance()
        {
            ...
            Info = new QuantityInfo<LuminanceUnit>(QuantityType.Luminance,
                new UnitInfo<LuminanceUnit>[] {
                    new UnitInfo<LuminanceUnit>(LuminanceUnit.CandelaPerSquareMeter, BaseUnits.Undefined),
                    new UnitInfo<LuminanceUnit>(LuminanceUnit.FootLambert, BaseUnits.Undefined),
                },
        ...
        /// </summary>
        public static QuantityType QuantityType { get; } = QuantityType.Luminance;

        /// <summary>
        ///     All units of measurement for the Luminance quantity.
        /// </summary>
        public static LuminanceUnit[] Units { get; } = Enum.GetValues(typeof(LuminanceUnit)).Cast<LuminanceUnit>().Except(new LuminanceUnit[]{ LuminanceUnit.Undefined }).ToArray();
        ...
        /// <summary>
        ///     Get Luminance in CandelaPerSquareMeters.
        /// </summary>
        public double CandelaPerSquareMeters => As(LuminanceUnit.CandelaPerSquareMeter);

        /// <summary>
        ///     Get Luminance in FootLamberts.
        /// </summary>
        public double FootLamberts => As(LuminanceUnit.FootLambert);
        ...
        /// <summary>
        ///     Get Luminance from CandelaPerSquareMeters.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Luminance FromCandelaPerSquareMeters(QuantityValue candelapersquaremeters)
        {
            double value = (double) candelapersquaremeters;
            return new Luminance(value, LuminanceUnit.CandelaPerSquareMeter);
        }
        /// <summary>
        ///     Get Luminance from FootLamberts.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Luminance FromFootLamberts(QuantityValue footlamberts)
        {
            double value = (double) footlamberts;
            return new Luminance(value, LuminanceUnit.FootLambert);
        }
        ...
        {
            return left.CandelaPerSquareMeters / right.CandelaPerSquareMeters;
        }
        ...
        IQuantity IQuantity.ToUnit(Enum unit)
        {
            ...
            return ToUnit(unitAsLuminanceUnit);
        }
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case LuminanceUnit.FootLambert: return _value;
                default:
        ...
        /// </summary>
        /// <returns>The value in the base unit representation.</returns>
        internal Luminance ToBaseUnit()
        {
            var baseUnitValue = GetValueInBaseUnit();
            return new Luminance(baseUnitValue, BaseUnit);
        }
        ...
        private double GetValueAs(LuminanceUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case LuminanceUnit.FootLambert: return baseUnitValue;
                default:
