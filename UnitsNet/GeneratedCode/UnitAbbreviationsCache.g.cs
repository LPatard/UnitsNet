...
namespace UnitsNet
{
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ("en-US", typeof(AbsorbedDoseUnit), (int)AbsorbedDoseUnit.Gray, new string[]{"Gy"}),
                ("en-US", typeof(AbsorbedDoseUnit), (int)AbsorbedDoseUnit.Sievert, new string[]{"Sv"}),
                ...
                ("en-US", typeof(AccelerationUnit), (int)AccelerationUnit.MilesPerSquareSecond, new string[]{"mi/s²"}),
                ...
                ("en-US", typeof(ActivityUnit), (int)ActivityUnit.Becquerel, new string[]{"Bq"}),
                ...
                ("en-US", typeof(AngleUnit), (int)AngleUnit.MeterPerMillimeter, new string[]{"m/mm"}),
                ...
                ("en-US", typeof(AngleUnit), (int)AngleUnit.MillimeterPerMeter, new string[]{"mm/m"}),
                ...
                ("en-US", typeof(AreaUnit), (int)AreaUnit.SquareChain, new string[]{"ch²"}),
                ...
                ("en-US", typeof(AreaUnit), (int)AreaUnit.ThousandCircularMil, new string[]{"kcmil"}),
                ...
                ("en-US", typeof(AreaDensityUnit), (int)AreaDensityUnit.GramPerSquareMeter, new string[]{"g/m²"}),
                ("en-US", typeof(AreaDensityUnit), (int)AreaDensityUnit.KilogramPerSquareCentimeter, new string[]{"kg/cm²"}),
                ("en-US", typeof(AreaDensityUnit), (int)AreaDensityUnit.KilogramPerSquareMeter, new string[]{"kg/m²"}),
                ("en-US", typeof(AreaDensityUnit), (int)AreaDensityUnit.KipsPerSquareFoot, new string[]{"kip/ft²"}),
                ("en-US", typeof(AreaDensityUnit), (int)AreaDensityUnit.KipsPerSquareInch, new string[]{"ksi"}),
                ...
                ("en-US", typeof(AreaVolumeRationUnit), (int)AreaVolumeRationUnit.SquareMeterPerLiter, new string[]{"m²/l"}),
                ("en-US", typeof(BaudRateUnit), (int)BaudRateUnit.Baud, new string[]{"Bd"}),
                ...
                ("en-US", typeof(CatalyticActivityUnit), (int)CatalyticActivityUnit.Katal, new string[]{"Kat"}),
                ("en-US", typeof(CatalyticVolumeActivityUnit), (int)CatalyticVolumeActivityUnit.KatalPerCubicMeter, new string[]{"kat/m³"}),
                ...
                ("en-US", typeof(DensityUnit), (int)DensityUnit.KilogramPerCubicDecimeter, new string[]{"kg/dm³"}),
                ...
                ("en-US", typeof(DiffusivityUnit), (int)DiffusivityUnit.SquareMeterPerHour, new string[]{"m²/h"}),
                ("en-US", typeof(DoseRateUnit), (int)DoseRateUnit.GrayPerSecond, new string[]{"Gy/s"}),
                ...
                ("en-US", typeof(ElectricChargeUnit), (int)ElectricChargeUnit.KiloCoulomb, new string[]{"KC"}),
                ...
                ("en-US", typeof(ElectricConductivityUnit), (int)ElectricConductivityUnit.MillisiemensPerCentimeter, new string[]{"mS/cm"}),
                ...
                ("en-US", typeof(ElectricResistivityUnit), (int)ElectricResistivityUnit.MilliohmPerMeter, new string[]{"mΩ.m"}),
                ...
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.WattSecondCubicMeter, new string[]{"Ws/m³"}),
                ...
                ("en-US", typeof(FrequencyUnit), (int)FrequencyUnit.CyclePerSecond, new string[]{"cps"}),
                ...
                ("en-US", typeof(HeatCapacityUnit), (int)HeatCapacityUnit.BTUPerFahrenheitDegree, new string[]{"BTU/°F"}),
                ...
                ("en-US", typeof(HeatTransferCoefficientUnit), (int)HeatTransferCoefficientUnit.BtuPerHourSquarefeetFahrenheit, new string[]{"BTU/(h·ft²·°F)"}),
                ...
                ("en-US", typeof(HeatTransferCoefficientUnit), (int)HeatTransferCoefficientUnit.WattPerSquareMetterPerKelvin, new string[]{"W/m2/K"}),
                ("en-US", typeof(IlluminanceUnit), (int)IlluminanceUnit.FootCandle, new string[]{"ftc"}),
                ...
                ("en-US", typeof(IonDoseUnit), (int)IonDoseUnit.CoulombPerKilogramm, new string[]{"C/kg"}),
                ...
                ("en-US", typeof(LengthUnit), (int)LengthUnit.Furlong, new string[]{"fur"}),
                ...
                ("en-US", typeof(LengthUnit), (int)LengthUnit.League, new string[]{"Lea"}),
                ("en-US", typeof(LengthUnit), (int)LengthUnit.LightYear, new string[]{"ly"}),
                ("en-US", typeof(LengthUnit), (int)LengthUnit.Link, new string[]{"li"}),
                ...
                ("en-US", typeof(LengthUnit), (int)LengthUnit.Rod, new string[]{"rd"}),
                ...
                ("en-US", typeof(LuminanceUnit), (int)LuminanceUnit.CandelaPerSquareMeter, new string[]{"cd/m²"}),
                ("en-US", typeof(LuminanceUnit), (int)LuminanceUnit.FootLambert, new string[]{"ftL"}),
                ...
                ("en-US", typeof(LuminousEfficacyUnit), (int)LuminousEfficacyUnit.LumenPerWatt, new string[]{"lm/W"}),
                ...
                ("en-US", typeof(MassFlowUnit), (int)MassFlowUnit.GramPerMinute, new string[]{"g/min"}),
                ...
                ("en-US", typeof(PermeanceUnit), (int)PermeanceUnit.GrainsPerHourSquareFootInchOfMercury, new string[]{"gr/(h·ft²·inHg)"}),
                ("en-US", typeof(PermeanceUnit), (int)PermeanceUnit.Perm, new string[]{"ng/(Pa·s·m²)"}),
                ("en-US", typeof(PermittivityUnit), (int)PermittivityUnit.FaradPerMeter, new string[]{"F/m"}),
                ("en-US", typeof(PermittivityUnit), (int)PermittivityUnit.MicroFaradPerKilometer, new string[]{"μF/km"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.BTUPerSecond, new string[]{"Btu/s"}),
                ("en-US", typeof(PowerUnit), (int)PowerUnit.CaloriePerSecond, new string[]{"cal/s"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.GigajoulePerYear, new string[]{"GJ/year"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.KilocaloriePerSecond, new string[]{"kcal/s"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.TonOfRefrigeration, new string[]{"Ton of refrigeration"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.FootOfWater, new string[]{"ftH2O"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.MeterOfWaterColumn, new string[]{"mH2O"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.WaterMeter, new string[]{"mCE"}),
                ("en-US", typeof(PressureUnit), (int)PressureUnit.WaterMillimeter, new string[]{"mmCE"}),
                ...
                ("en-US", typeof(PressureGradientUnit), (int)PressureGradientUnit.PascalPerMeter, new string[]{"Pa/m"}),
                ("en-US", typeof(RadianceUnit), (int)RadianceUnit.WattPerSquareMeterSteradian, new string[]{"W/(m².sr)"}),
                ("en-US", typeof(RadiantIntensityUnit), (int)RadiantIntensityUnit.WattPerSteradian, new string[]{"W/sr"}),
                ...
                ("en-US", typeof(SpaceVelocityUnit), (int)SpaceVelocityUnit.LiterPerSecondCubicMeter, new string[]{"L/(s·m³)"}),
                ("en-US", typeof(SpecificAreaUnit), (int)SpecificAreaUnit.SquareFootPerTon, new string[]{"ft²/ton"}),
                ("en-US", typeof(SpecificDischargeUnit), (int)SpecificDischargeUnit.CubicFootMinutePerSquareFoot, new string[]{"ft³/(min.ft²)"}),
                ("en-US", typeof(SpecificDischargeUnit), (int)SpecificDischargeUnit.CubicMeterPerHourSquareMeter, new string[]{"m3/(h.m2)"}),
                ("en-US", typeof(SpecificDischargeUnit), (int)SpecificDischargeUnit.LiterSecondPerSquareMeter, new string[]{"L/(s.m²)"}),
                ...
                ("en-US", typeof(SpecificEnergyUnit), (int)SpecificEnergyUnit.JoulePerGram, new string[]{"J/g"}),
                ...
                ("en-US", typeof(SpecificHeatEnergyUnit), (int)SpecificHeatEnergyUnit.JoulePerGramCelciusDegree, new string[]{"J/(g·°C)"}),
                ("en-US", typeof(SpecificLengthUnit), (int)SpecificLengthUnit.MeterPerGram, new string[]{"m/g"}),
                ...
                ("en-US", typeof(TemperatureCoefficientUnit), (int)TemperatureCoefficientUnit.PercentageByKelvin, new string[]{"%/K"}),
                ...
                ("en-US", typeof(ThermalLengthExpansionUnit), (int)ThermalLengthExpansionUnit.MillimeterPerMeterKelvinDegree, new string[]{"mm/(m.K)"}),
                ("en-US", typeof(ThermalConductanceUnit), (int)ThermalConductanceUnit.WattPerKelvin, new string[]{"W/K"}),
                ...
                ("en-US", typeof(ThermalInsulanceUnit), (int)ThermalInsulanceUnit.SquareMeterCelciusDegreePerKilowatt, new string[]{"m².°C/kW"}),
                ...
                ("en-US", typeof(TorqueUnit), (int)TorqueUnit.KipsPerInch, new string[]{"kip/in"}),
                ...
                ("en-US", typeof(TorqueUnit), (int)TorqueUnit.TonForcePerMeter, new string[]{"tf/m"}),
                ...
                ("en-US", typeof(TorquePerLengthUnit), (int)TorquePerLengthUnit.DecanewtonMeterPerMeter, new string[]{"daN-m/m"}),
